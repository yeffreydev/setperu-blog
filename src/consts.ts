 ...
 */
export const site = {
  title: "Blog de Set Perú", // requerido
  favicon: "/favicon.svg", // requerido
  description:
    "¡Bienvenido al blog de Set Perú! Aquí encontrarás artículos sobre tecnología, desarrollo web y más.", // requerido
  author: "Set-Peru", // requerido
  avatar: "/avatar.png", // requerido
  url: "https:/blog.setperu.com", // requerido
  baseUrl: "", // Cuando uses GitHubPages, debes ingresar el nombre del repositorio comenzando con '/'. ej. '/astro-blog'
  motto: "Las acciones hablan más que las palabras.",
  recentBlogSize: 5,
  archivePageSize: 25,
  postPageSize: 10,
  feedPageSize: 20,
...
export const infoLinks = [
  ...
  // },
  {
    icon: "ri-github-fill",
    name: "github",
    outlink: "https://github.com/yeffreydev/setperu-blog",
  },
  // {
  //   icon: "ri-rss-fill",
  //   name: "rss",
